        ...
        <div class="invoice_numbers">
            ...
            <table class="invoice_numbers_table">
                <tr>
                    ...
                    <td class="strong right">Cena</td>
                    <td class="strong right">% DPH</td>
                    <td class="strong right">DPH</td>
                    <td class="strong right last">Celkem s DPH</td>
                </tr>
                <tr>
                    <td>{car_sentence}</td>
            ...
            <div class="partial_prices">

                <table class="partial_prices_table_parent">

                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            <table class="partial_prices_table_child">
                                <tr>
                                    <td class="left">Základ DPH:</td>
                                    <td class="right">{order_dph_base}</td>
                                </tr>
                                <tr>
