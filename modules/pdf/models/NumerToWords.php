...
class NumerToWords
{
    ...
    public static function convert($number, $units = null, $level = -1)
    {
        ...
        $dictionary  = array(
            ...
            1000                => 'tisíc',
            1000000             => 'milión',   // e6
            1000000000          => 'miliarda|miliardy|miliard', // e9
            1000000000000       => 'bilión',   // e12
            1000000000000000    => 'biliarda|biliardy|biliard', // e15
            ...
            default:
                ...
                if (in_array($baseUnit, [1e9, 1e15])) {
                    ...
                    if ($numBaseUnits >= 2 && $numBaseUnits <= 4) {
                        ...
                        $append = $append[2]; // 5,6 ... 99 miliard, biliard
                    } else {
    ...
    public static function convertToWords($num, $langCode = 'cs')
    {
        if (!extension_loaded('intl')) {
            return self::convert($num, $langCode);
        }

        return self::convertIntl($num, $langCode);
    }
}
